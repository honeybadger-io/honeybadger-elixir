defmodule Honeybadger.HTTPAdapter.FinchTest do
  use Honeybadger.Case
  doctest Honeybadger.HTTPAdapter.Finch

  alias Honeybadger.HTTPAdapter.Finch, as: FinchAdapter
  ...
  describe "request/4" do
    test "without supervisor" do
      ...
      assert_raise RuntimeError,
                   "Missing `:supervisor` option for the Honeybadger.HTTPAdapter.Finch configuration",
                   fn ->
